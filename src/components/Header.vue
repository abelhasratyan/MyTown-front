          ...
          <div class="row headerContent">
              ...
              <div class="col-lg-4 col-md-9 col-9">
                  <form class="searchBox">
                      ...
                      <span class="searchIcon"><img src="../assets/images/icons/search.png" alt="search icon"></span>
                  </form>
              </div>
                      ...
                      <ul class="headerList">
                          <li>
                              <router-link :to="{name: 'friends'}">
                                  <span class="iconBox Friends"><img src="@/assets/images/icons/navIcon1.png" alt="icon"><span class="notiCount">4</span></span>
                                  <span class="textBox">Friends</span>
                              </router-link>
                          </li>
                          <li class="hasChild">
                              <a>
                                  <span class="iconBox Messages"><img src="@/assets/images/icons/navIcon2.png" alt="icon"><span class="notiCount">4</span></span>
                          ...
                          <li>
                              <router-link to="">
                                  <span class="iconBox Notification"><img src="@/assets/images/icons/navIcon3.png" alt="icon"><span class="notiCount">4</span></span>
                          ...
                          <li class="burgerMenu">
                              <router-link to="">
                                  <span class="iconBox Friends"><img src="../assets/images/icons/menu.png" alt="icon"></span>
                              </router-link>
                          </li>
                      </ul>
                  </nav>
